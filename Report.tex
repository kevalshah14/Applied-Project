...
\begin{enumerate}
    ...
    \item \textbf{Open-Source Implementation:} We provide a complete, working implementation as an open-source project, including a Next.js frontend and a Python FastAPI backend. The source code is available at: \url{https://github.com/kevalshah14/Applied-Project}.
\end{enumerate}
