...
# Config
# Point-like ROI (very small rectangle)
point_x = 0.5
point_y = 0.5
roi_size = 0.02  # 2% of the image size

topLeft = dai.Point2f(point_x - roi_size/2, point_y - roi_size/2)
bottomRight = dai.Point2f(point_x + roi_size/2, point_y + roi_size/2)
...
# High Detail profile for 3D scanning and object details
stereo.setDefaultProfilePreset(dai.node.StereoDepth.PresetMode.HIGH_DETAIL)

stepSize = 0.05

config = dai.SpatialLocationCalculatorConfigData()
config.depthThresholds.lowerThreshold = 30  # 3cm minimum for Face profile
config.depthThresholds.upperThreshold = 3000  # 3m maximum for Face profile
